...
INPUT_FILE = "../../../../dataset/filtered_data/device_category_data/Thermostat_Heating_normalized_for_oversampling.csv"          # dataset originale
OUTPUT_FILE = "../../../../dataset/filtered_data/device_category_data/Thermostat_Heating_normalized_for_oversampling_oversampled_final.csv"    # dataset generato
...
trigger_synonyms = {
        ...
        "specified": ["chosen", "indicated"],
        "turned on": ["started", "activated"]
}

action_synonyms = {
    "turn on": ["start", "activate", "started", "turned on"],
    "start": ["turn on", "activate", "started", "turned on"],
    "activate": ["turn on", "start", "started", "turned on"],
    "turned on": ["started", "activated"],
    "started": ["turned on", "activated"],

    "turn off": ["stop", "deactivate", "stopped", "turned off"],
    "stop": ["turn off", "deactivate", "stopped", "turned off"],
    "deactivate": ["turn off", "stop", "stopped", "turned off"],
    "turned off": ["stop", "deactivate"],
    "stopped": ["turn off", "deactivate"],
...
df_filtered = df[~df["triggerDesc"].str.contains(r"\[FREE\]", regex=True)]
