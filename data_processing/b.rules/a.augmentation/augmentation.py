...
OUTPUT_CSV = "../../../dataset/rules/types_augmented_dataset.csv"
REPORT_FILE = "augmentation_report.txt"
...
TRIGGER_KEYWORDS = {
    ...
    "external_service": ["facebook", "android", "calendar", "apilio", "spotify", "youtube", "ifttt"],
    "motion": ["enter an area", "exit an area", "member arrives", "member leaves", "motion", "exit", "enter"],
    "schedule": [
        "sunset", "sunrise", "specific time", "within \\d+ minutes", "hours", "hour", "minutes",
        "seconds", "day", "days", "every single day", "once a year", "every time", "only on specific days"
    ],
    "weather": ["temperature", "weather"],
    "device_state": ["scene is changed", "turned on", "turned off", "unlocked", "opened", "closed", "locked"]
}
...
ACTION_KEYWORDS = {
    "turn_on_off": ["turn on", "turn off", "switch on", "switch off", "turn"],
    "set_value": ["set .* temperature", "set .* brightness", "dim", "brighten", "temperature", "brightness", "low", "\\d+\\s?%"],
    "set_mode": ["set .* scene", "activate .* scene", "guardian scene", "home scene", "away scene", "night scene", "mode", "color", "scene", "auto", "manual"],
    "toggle": ["toggle"],
    "effect": ["blink", "breathe", "color loop", "change the color"],
    "start_stop": ["start", "stop", "cancel", "lock", "unlock"],
