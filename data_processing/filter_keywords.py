...
OUTPUT_FILTERED = "../dataset/keywords_filtered_dataset.csv"
OUTPUT_REPORT = "../dataset/keywords_report.txt"
...
keyword_pattern = re.compile(
    "|".join(map(re.escape, SEARCH_KEYWORDS)),
    re.IGNORECASE
)
...
filtered_df = df[df.apply(row_matches_keywords, axis=1)]
